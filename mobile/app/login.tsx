  ...
  return (
    <SafeAreaView style={{ flexDirection: "row", justifyContent: "center", alignItems: "center", width: "100%", height: "100%" }}>
      <View style={{ width: "100%", height: "100%", flexDirection: "column", gap: 10, justifyContent: "center", alignItems: "center" }}>
        ...
        <TextInput style={{ backgroundColor: "#212121", color: "white", fontSize: 12, padding: 15, borderRadius: 10, width: "80%", marginBottom: 10 }} placeholder='Enter your email' placeholderTextColor={"grey"} />
        <TextInput style={{ backgroundColor: "#212121", color: "white", fontSize: 12, padding: 15, borderRadius: 10, width: "80%", marginBottom: 10 }} placeholder='Enter your password' placeholderTextColor={"grey"} />
        <Pressable style={{
          height: 48,
          width:"80%",
